<?php 
	...
	if(!empty($index_top_row) && ($index_top_row != "none")){
		$widget_types = elgg_get_widget_types("magazine", false);
		
		elgg_push_context('widgets');
		$widgets = elgg_get_widgets(elgg_get_page_owner_entity()->getGUID(), "magazine");
	...
	echo elgg_view_page(elgg_echo('magazine'), $body);
