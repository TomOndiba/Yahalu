...
/***** TOPBAR ******/
.elgg-page-topbar {
	background: #444 url(<?php echo elgg_get_site_url(); ?>mod/bright-theme/graphics/topbar.png) repeat;
...
.elgg-page-header {
	...
	background: transparent url(<?php echo elgg_get_site_url(); ?>mod/bright-theme/graphics/header-gradients.png) no-repeat;
