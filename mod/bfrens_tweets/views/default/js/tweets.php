...
elgg.provide('elgg.tweets');

elgg.tweets.init = function() {
	$("#tweets-textarea").live('keydown', function() {
		elgg.tweets.textCounter(this, $("#tweets-characters-remaining span"), 140);
	});
	$("#tweets-textarea").live('keyup', function() {
		elgg.tweets.textCounter(this, $("#tweets-characters-remaining span"), 140);
	});

	$(".thewire-previous").live('click', elgg.tweets.viewPrevious);
};
 ...
 * @return void
 */
elgg.tweets.textCounter = function(textarea, status, limit) {
 ...
 * @return void
 */
elgg.tweets.viewPrevious = function(event) {
	var $link = $(this);
...
elgg.register_hook_handler('init', 'system', elgg.tweets.init);