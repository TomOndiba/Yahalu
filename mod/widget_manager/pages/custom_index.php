<?php 
	...
	if (empty($name))$name=$user->name.elgg_echo('bf:owners:page');
	else $name .=elgg_echo('bf:owners:page');
	...
	$body = elgg_view_layout('one_column', array('content' =>  $style . $content, 'title' => $name ));
	...
	echo elgg_view_page("", $body, "shells/font");
