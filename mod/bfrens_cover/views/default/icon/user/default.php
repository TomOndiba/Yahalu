...
if (!in_array($size, array('topbar', 'tiny', 'small', 'medium', 'medium2', 'large', 'large2', 'master' , 'cover'))) {
	$size = 'medium';
}
...
$icon = elgg_view('output/img', array(
	...
	'title' => $name,
	'class' => $img_class,
	'style' => "background: url($icon_url) no-repeat; background-size:970px;",
));
}
else 
{
$icon = elgg_view('output/img', array(
	...
	'title' => $name,
	'class' => $img_class,
	'style' => "background: url($icon_url) no-repeat; background-size:100%",
));
}
