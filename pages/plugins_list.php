<?php
	...
	// Display main admin menu
		//echo elgg_view("admin/plugins_list", array('installed_plugins' => get_installed_plugins()) );
		//echo "END";
?>
<?php
	...
	// Get the installed plugins
		$installed_plugins = get_installed_plugins(); //$vars['installed_plugins'];
	...
	echo "<tr><td>" . $n . "</td><td>" . $plugin . "</td><td>Active</td><td>" . $manifest['description'] . "</td></tr>";
	}
	else
	{
	echo "<tr><td>" . $n . "</td><td>" . $plugin . "</td><td>&nbsp;</td><td>" . $manifest['description'] . "</td></tr>";
	}
